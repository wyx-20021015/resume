...
const experiences = [
  {
    ...
    to: '2022/12/1',
    description:
      '一款帮助同学们趣味学习单词的软件;本人负责前端部分的开发;实现了登录、切词、收藏、评论、阅读推荐等功能;使用mobx管理全局状态;vant组件库搭建布局;使用Promise封装了小程序原生的接口，使用节流函数防止恶意点击;echart展示每日进度;通过代码分包优化了首屏加载;在项目中强化了自己的小程序端开发能力和布局能力。',
    links: [
      {
        name: 'gitee地址',
  ...
  },
  {
    ...
    to: '2023/2/16',
    description:
      '合作完成的react组件库;团队内担任队长,负责技术选型、环境搭建和form、button、progress、input、typewriter组件的开发;使用tsx编写组件逻辑;dumi编写文档站;jest+rtl+ts-jest单元测试;less编写样式;在本项目中提高了自己的react能力和组件化思维，感受了单元测试带来的质量保障，也收获了一次宝贵的领导经验。',
    links: [
      {
        name: '代码地址',
